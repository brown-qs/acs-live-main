...
const makeSlug = (options = {}, fieldConfig) => async (
  source,
  args,
  context,
  info
  ...
  const fromValue =
    (fieldValue && (fieldValue.slug || fieldValue.name || fieldValue.title)) ||
    (source &&
...
const normalizeSocial = (options = {}, fieldConfig) => async (
  source,
  args,
  context,
  info
...
const blockContentToMarkdown = (options = {}, fieldConfig) => async (
  source,
  args,
  context,
  info
